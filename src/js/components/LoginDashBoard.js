      ...
      html: `<div id="LoginDashBoard" class="user-management-view" style="display:none">
        <form class="v-form box-shadow" method="post" autocomplete="on">
            ...
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <input cb:onChange="handleInputChange" cb:name="username" type="username" id="username" class="mdl-textfield__input" autocomplete="username">
            ...
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <input cb:onChange="handleInputChange" cb:name="password" class="mdl-textfield__input" type="password" id="password" autocomplete="current-password">
                <label class="mdl-textfield__label" for="password">Passwort</label>
                <span class="mdl-textfield__error" id="login-password-error"></span>                
            </div><br>
            <button cb:onClick="handleLogin" type="button" value="Sign In" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">Login</button><br>
